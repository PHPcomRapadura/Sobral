        ...
        <div class="row">
            <div class="col s12 m6">
                <div class="icon-block">
                    <img id="img-banner" class="responsive-img" src="assets/img/image-about-medium.png" alt="PHP com Rapadura">
                </div>
            </div>
            ...
            <div class="col s12 m6">
                <div class="icon-block">
                    ...
                    <h4 class="center font-blue">O maior evento de PHP da Região Norte do Estado do Ceará</h4>

                    <p class="font-blue center">
